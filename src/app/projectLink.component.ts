  ...
  <a routerLink="/p/{{project.url_token}}" style="text-decoration: none;">
    ...
    <div class="well no-padding" style="cursor: pointer; min-height: 370px;">
      ...
      <div style="width: 100%; padding-top: 33.3%; position: relative;">
          <img *ngIf="project.cover_photo_s3_url" style="position: absolute; top: 0; left: 0; bottom: 0; width: 100%"  [src]="project.cover_photo_s3_url"/>
      ...
      <div *ngIf="project.status == 'ready'" style="height: 15px; margin-top: 9px; margin-left: calc(30% + 9px); width: calc(35% - 18px); display: inline-block;">
          <div align="center">
      ...
      <div *ngIf="project.status == 'cancelled'" style="height: 15px; margin-top: 0px; margin-left: calc(30% + 9px); width: calc(35% - 9px); display: inline-block;">
          <div align="center">
      ...
      <div style="margin-bottom: calc(15% - 18px);"></div>

      <h6 align="center" style="margin-bottom: 15px;">{{ project.project_owner_name }}</h6>
      <h4 style="padding-left: 10px; padding-right: 10px; line-height: 25px; margin-bottom: 20px; height: 70px;" align="center">{{project.name}}</h4>

      <p *ngIf="!project.complete_percentage" align="center" style="margin-bottom: 3px; font-size: 20px; font-family: 'Montserrat', sans-serif; color: #2dc3e8">{{ project.step_count }}</p>
      <h6 *ngIf="!project.complete_percentage" align="center" style="margin-bottom: 20px;">askelta otettu</h6>

      <p *ngIf="project.complete_percentage" align="center" style="margin-bottom: 3px; font-size: 20px; font-family: 'Montserrat', sans-serif; color: #2dc3e8">{{ project.complete_percentage | number : '1.0-1' }} %</p>
      <h6 *ngIf="project.complete_percentage" align="center" style="margin-bottom: 20px;">projektista suoritettu</h6>


      <div *ngIf="project.last_update">
        <h6 align="center" style="margin-bottom: 0px;">Päivitetty</h6>
        <p align="center" style="margin-bottom: 15px;">{{ project.last_update }}</p>
      </div>
